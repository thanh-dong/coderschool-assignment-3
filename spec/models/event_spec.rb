...
RSpec.describe Event, type: :model do
  ...
  it 'validate the presence of value_id' do
    category = Category.create(id: 1)
    event = Event.new(name: 'event name', starts_at: DateTime.current, ends_at: DateTime.current, category: category, published: true, extended_html_description: 'content')
    event.save
  ...
  it 'validate the presence of extended_html_description' do
    venue = Venue.create(id: 1)
    event = Event.new(name: 'event name', starts_at: DateTime.current, ends_at: DateTime.current, extended_html_description: 'content', venue: venue, published: true)
    event.save
  ...
  describe '#search' do
    it 'should return all active events' do
      category = Category.create!(id: 1, name: 'Entertainment')
      venue = Venue.create!(id: 1)
      event_1 = Event.create!(name: 'Pool party event', starts_at: DateTime.current - 2.days, ends_at: DateTime.current - 1.day, category: category, venue: venue, published: true, extended_html_description: 'content')
      event_2 = Event.create!(name: 'Charity event', starts_at: DateTime.current - 1.day, ends_at: DateTime.current + 1.day, category: category, venue: venue, published: true, extended_html_description: 'content')
      event_3 = Event.create!(name: 'Xmas', starts_at: DateTime.current - 3.days, ends_at: DateTime.current - 2.days, category: category, venue: venue, published: true, extended_html_description: 'content')
      event_4 = Event.create!(name: 'Social event', starts_at: DateTime.current - 1.day, ends_at: DateTime.current + 1.day, category: category, venue: venue, published: true, extended_html_description: 'content')
